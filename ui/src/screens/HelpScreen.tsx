    ...
    <div className="max-w-2xl">
      <div className="bg-surface rounded-lg border border-edge p-6">
        ...
        <div className="space-y-4 text-sm text-muted">
          <section>
            <h3 className="font-medium text-body mb-1">Accounts</h3>
